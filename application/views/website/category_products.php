<style id='techmarket-woocommerce-style-inline-css' type='text/css'>
    ...
    @media (max-width: 576px) {
         .site-main .columns-4 .products:not(.slick-slider) .product {
...
<?php
$query="SELECT category_title,category_name FROM `category` WHERE category_id=$parent_id limit 1 ";
 $results=get_result($query);
if(isset($results)) {
    $categor_n_link = base_url() . 'category/' . $results[0]->category_name;
    $categor_n_title = $results[0]->category_title;
}
?>
<div class="wrapper">
    ...
    <div class="col-full">
        <div class="row">
            <nav class="woocommerce-breadcrumb"><a href="<?php echo base_url() ?>">Home</a>
                <?php if(isset($categor_n_link)) { ?>
                <span class="delimiter"><i class="fa fa-fw fa-angle-right"></i></span><a
                    href="<?= $categor_n_link ?>"><?= $categor_n_title ?></a>
                <?php } ?>

                <span class="delimiter"><i class="fa fa-fw fa-angle-right"></i></span><a
                    href="<?= $breadcumb_category_link ?>"><?= $breadcumb_category ?></a>
            ...
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                    ...
                    <div class="shop-control-bar">
                        ...
                        <h1 class="woocommerce-products-header__title page-title"><?= $breadcumb_category ?></h1>

                    </div>
                    <div class="tab-content">

                        <div id="grid-extended" class="tab-pane  active" role="tabpanel" aria-expanded="true">
                    ...
                    <ul class="product-categories category-single">
                        <li class="product_cat">
                            <ul class="show-all-cat">
                                <li class="product_cat">
                                    <span class="show-all-cat-dropdown">Show All Categories <i
                                            class="fa fa-fw fa-angle-right"></i></span>
...
<script>
    jQuery(document).ready(function () {
        ...
        function load_data(limit, start) {
            ...
            jQuery.ajax({
                url: "<?php echo base_url()?>/ajax/scroll_category_product",
                method: "POST",
